/**
 * AIDEV-NOTE: Gráfico de Motivos de Perda (PRD-18)
...
export default function MotivosPerda({ data }: MotivosPerdasProps) {
  if (!data || data.length === 0) {
    return (
      <div className="bg-card border border-border rounded-xl p-6">
        <div className="flex items-center gap-2 mb-4">
          <XCircle className="w-4 h-4 text-red-500" />
          <h3 className="text-sm font-semibold text-foreground">Principais Motivos de Perda</h3>
          <TooltipInfo>
            <p>Razões mais comuns pelas quais negócios foram perdidos no período.</p>
          </TooltipInfo>
        </div>
