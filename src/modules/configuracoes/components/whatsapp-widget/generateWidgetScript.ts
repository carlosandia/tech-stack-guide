/**
 * AIDEV-NOTE: Gerador de script embed DINÂMICO para Widget WhatsApp
 * Gera um loader leve que busca config da edge function em tempo real.
...
export function generateWidgetScript(organizacaoId: string): string {
  return `<!-- Widget WhatsApp - CRM Renove (dinâmico) -->
<script>
(function(){
  var API='${SUPABASE_URL}/functions/v1/widget-whatsapp-config?org=${organizacaoId}';
