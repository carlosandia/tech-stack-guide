 ...
 * Avatar, nome do contato, ações (status, drawer)
 */

import { ArrowLeft, MoreVertical, CircleDot } from 'lucide-react'
...
export function ChatHeader({ conversa, onBack, onOpenDrawer, onAlterarStatus }: ChatHeaderProps) {
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-1.5">
              ...
              {conversa.canal === 'whatsapp' ? (
                ...
                <svg viewBox="0 0 24 24" className="w-3.5 h-3.5 flex-shrink-0" fill="url(#ig-gradient)">
                  <defs>
