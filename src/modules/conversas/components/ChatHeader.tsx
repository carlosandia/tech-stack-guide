          ...
          >
            ...
            <div className="min-w-0 flex flex-col justify-center">
              <div className="flex items-center gap-1 sm:gap-1.5">
                ...
                {/* AIDEV-NOTE: Etiquetas na mesma linha do nome — sobem junto quando digitando aparece */}
                <div className="hidden sm:flex items-center gap-1 min-w-0 flex-shrink-0">
              ...
              {/* AIDEV-NOTE: Indicador de presença alinhado à esquerda abaixo do nome — estilo WhatsApp Web */}
