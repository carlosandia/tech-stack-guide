...
/**
 * AIDEV-NOTE: Página pública de Termos de Serviço
 * Conforme requisitos Meta/Google Ads e legislação brasileira
 * URL: /termos
 * Usa componente compartilhado TermosConteudo (sincronizado com dialog do checkout)
 */
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-4 text-sm text-muted-foreground">
              <span className="text-foreground font-medium">Termos de Serviço</span>
              <span>|</span>
