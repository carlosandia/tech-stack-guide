...
function getFormScript(configApi: string, submitApi: string, mode: string, slug: string, anonKey: string): string {
  ...
  parts.push("function inputType(t){switch(t){case'email':return'email';case'telefone':case'telefone_br':return'tel';case'numero':case'decimal':case'moeda':return'number';case'url':return'url';default:return'text'}}")
