 ...
 *
 * SEGURANCA CRITICA: STRIPE_WEBHOOK_SECRET e OBRIGATORIO
 * Sem validacao de signature, qualquer pessoa pode forjar eventos de pagamento
 */
...
serve(async (req) => {
  ...
  try {
    ...
    // AIDEV-NOTE: SEGURANCA CRITICA - STRIPE_WEBHOOK_SECRET e obrigatorio
    // Sem ele, qualquer pessoa pode forjar eventos de pagamento e criar organizacoes fake
    // ou manipular assinaturas. NUNCA aceite webhooks sem validacao de signature.
    ...
    // AIDEV-NOTE: SEGURANCA - Verificar assinatura do webhook e OBRIGATORIO
