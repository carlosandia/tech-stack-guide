...
BEGIN
  ...
  -- AIDEV-NOTE: Total de atividades (audit_log) no período atual vinculadas a oportunidades ativas
  ...
  -- AIDEV-NOTE: Mesmo valor para manter compatibilidade com campo de variação
  v_total_periodo := v_total_historico;
