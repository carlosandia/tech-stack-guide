...
BEGIN
  -- Só processar se tem etapa_id e funil_id
...
DROP TRIGGER IF EXISTS trg_aplicar_config_pipeline ON oportunidades;
CREATE TRIGGER trg_aplicar_config_pipeline
  AFTER INSERT ON oportunidades
  FOR EACH ROW
  EXECUTE FUNCTION aplicar_config_pipeline_oportunidade();
