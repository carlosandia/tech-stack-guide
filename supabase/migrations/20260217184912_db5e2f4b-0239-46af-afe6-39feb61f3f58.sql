-- Atualizar trigger para propagar audio_url do template para a tarefa
  ...
  BEGIN
    FOR v_vinculo IN
      SELECT tt.id AS template_id, tt.titulo, tt.tipo, tt.descricao,
             ...
             tt.modo, tt.assunto_email, tt.corpo_mensagem, tt.audio_url
    ...
    LOOP
      ...
      INSERT INTO tarefas (
        ...
        modo, assunto_email, corpo_mensagem, audio_url
      ) VALUES (
        ...
        COALESCE(v_vinculo.modo, 'comum'), v_vinculo.assunto_email, v_vinculo.corpo_mensagem, v_vinculo.audio_url
      );
    END LOOP;
  EXCEPTION WHEN OTHERS THEN
