-- =====================================================
-- PRD-18: Função RPC fn_dashboard_metricas_gerais
-- Retorna perdas, tarefas abertas, motivos de perda,
-- produtos ranking e total histórico de oportunidades
-- =====================================================
...
BEGIN
  ...
  -- Tarefas em aberto (snapshot atual)
  ...
  -- Total histórico de oportunidades (sem filtro de período)
  ...
  -- Produtos ranking (top 5) - oportunidades ganhas
  ...
  FROM (
    SELECT
      ...
      SUM(op.valor_total)::numeric AS receita
