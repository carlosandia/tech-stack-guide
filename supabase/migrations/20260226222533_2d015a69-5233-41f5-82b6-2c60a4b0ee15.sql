-- AIDEV-NOTE: Corrigir contagem de reuniões no funil — COUNT(DISTINCT oportunidade_id) em vez de COUNT(DISTINCT r.id)
-- Isso garante que múltiplas reuniões no mesmo card de oportunidade contem como 1 no funil progressivo
...
BEGIN
  ...
  SELECT json_build_object(
    ...
    'reunioes_agendadas', (
      SELECT COUNT(DISTINCT r.oportunidade_id)
